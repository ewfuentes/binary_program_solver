...
file = "src/test_problems/p0201.mps"
file = "src/test_problems/pb-market-split8-70-4.mps"
file = "src/test_problems/p2m2p1m1p0n100.mps"
...
open("src/test_problems/p2m2p1m1p0n100.cu", "w") do io
    println(io, cpp)
end
