...
cuda::std::make_tuple(21, pair{15, 1})
    ...
    auto const problem = problem_t<16, 22, 64>{
        ...
        .rhs_n = {3, 4, 2, 1, 3, 4, 1, 3, 1, 2, 4, 4, 4, 4, 2, 4, 4, 1, 4, 4, 2, 3},
        .is_eq = bitset<22>::from(cuda::std::array<bool, 22>{true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true}),
